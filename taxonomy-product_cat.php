...
if ($current_category && ! is_wp_error($current_category)) {
    $category_descr = get_field('statya', 'product_cat_' . $current_category->term_id);
}
?>

<!-- <?php if (! empty($category_descr)) : ?>
    <section class="category-descr">
        <div class="container">
            ...
            <div class="category-descr__content">
                <?php echo wp_kses_post($category_descr); ?>
            </div>
